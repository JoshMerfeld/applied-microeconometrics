...
- Mean for male-headed households: `r format(mean(df$in_poverty[df$h_male==1]), digits = 3)`
  - odds ($\frac{p_m}{1-p_m}$): `r format(mean(df$in_poverty[df$h_male==1])/(1-mean(df$in_poverty[df$h_male==1])), digits = 3)`
\vfill
- Odds ratio: `r format((mean(df$in_poverty[df$h_male==1])/(1-mean(df$in_poverty[df$h_male==1])))/(mean(df$in_poverty[df$h_male==0])/(1-mean(df$in_poverty[df$h_male==0]))), digits = 3)`
 \vfill
